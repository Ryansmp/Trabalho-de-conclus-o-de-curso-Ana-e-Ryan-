...
<body>
    ...
    <div class="d-flex">
        <div class="sidebar">
            ...
            <a href="checklist.php" class="nav-link"><i class="bi bi-checklist"></i> Checklist</a>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="doc_input" name="cpf_cnpj" placeholder="000.000.000-00" maxlength="18" inputmode="numeric" required>
